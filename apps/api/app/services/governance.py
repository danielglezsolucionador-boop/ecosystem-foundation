    ...
    return [
        ...
        GovernancePolicy(
            ...
            rules=[
                ...
                "CEREBRO may operate internally without external runtime connections.",
                "FORJA and other permitted departments may receive prepared tasks only inside the controlled backend.",
