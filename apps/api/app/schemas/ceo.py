...
class CeoDailyCenter(BaseModel):
    ...
    ecommerce_readiness: dict[str, Any] = Field(default_factory=dict)
    amazon_readiness: dict[str, Any] = Field(default_factory=dict)
    publishing: dict[str, Any] = Field(default_factory=dict)
    product_readiness: dict[str, Any] = Field(default_factory=dict)
    real_world: dict[str, Any] = Field(default_factory=dict)
    real_world_execution: dict[str, Any] = Field(default_factory=dict)
    social_identity: dict[str, Any] = Field(default_factory=dict)
